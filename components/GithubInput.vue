<template>
  <form
    class="flex w-full flex-col items-stretch gap-2 py-6 sm:flex-row"
    @submit.prevent="handleSubmit"
  >
    <input
      v-model="estimateStore.repo"
      type="text"
    ...
    <NuxtLink
      to="/settings"
      class="flex w-12 cursor-pointer items-center justify-center rounded-xl bg-gray-100 font-semibold text-gray-600 transition hover:bg-gray-200 active:scale-95"
    >
      <svg
